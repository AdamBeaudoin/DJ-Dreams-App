  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background/50 hover:bg-accent/40 hover:text-accent-foreground",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "hover:bg-white/5 hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        "pill-primary":
          "rounded-full min-h-[44px] touch-manipulation bg-primary/15 text-primary border border-primary/30 hover:bg-primary/25 hover:shadow-glow disabled:bg-muted disabled:text-muted-foreground disabled:border-transparent",
      },
      size: {
