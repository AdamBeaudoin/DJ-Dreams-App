...
description: Apply psychological principles and mental models to marketing. Understand why people buy, how to influence behavior ethically, and make better marketing decisions.
---
...
Check for product marketing context first: If .claude/product-marketing-context.md exists, read it before applying mental models. Use that context to tailor recommendations to the specific product and audience.
